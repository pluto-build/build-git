...
public class GitHandlerTest {
  ...
  public static void cloneRepo() {
    ...
    GitInput input = new GitInput.Builder(testRemote, "https://github.com/andiderp/dummy").addBranchToClone("feature").addBranchToClone("master2").build();
    try {
  ...
  public void checkCloneOtherBranchThanMaster() {
    ...
    in = new GitInput.Builder(repoLocation, this.dummyPath).setBranch("feature").build();
    try {
